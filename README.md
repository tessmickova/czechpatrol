...
Podrobněji: `docs/PRAVNI-KONTROLA.md`, `docs/DATOVY-MODEL.md`, `docs/PROVOZ.md`, `docs/ZNACKA.md`, `docs/DALSI-ETAPA.md`, `docs/SITUACNI-MAPA-NAVRH.md` (návrh situační mapy ČR, fáze 0), `docs/DOPISY-POSKYTOVATELUM.md` (dopisy poskytovatelům dat).
