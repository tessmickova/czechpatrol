...
import { NAZVY_HROZEB, seznamy, type Hrozba, type KlicSeznamu, type PolozkaSeznamu } from "./priprava";
import { UROVNE } from "./skala";

/*
  Tlak hrozeb a karta „Připravit teď“ — jen na serveru (při sestavení).
  Odděleno od priprava.ts 26. 9. 2026: seznamy zásob se čtou i v prohlížeči
  a nesmí s sebou táhnout všechny záznamy webu (testy/vykon.test.ts).
*/
