...
export const STAVY_ZPRAV: Record<ZpravaIzs["stav"], { nazev: string; tridy: string }> = {
  ...
  odeslano: { nazev: "Odesláno", tridy: "border-[#4fdd9a]/40 bg-[#4fdd9a]/10 text-[#8ff0c0]" },
  zamitnuto: { nazev: "Zamítnuto", tridy: "border-[#ff5c6c]/40 bg-[#ff5c6c]/10 text-[#ff8c98]" },
};
  ...
  return (
    <li className="rounded-[14px] border border-linka p-4">
      ...
      {typeof z.doruceno === "number" && z.stav === "odeslano" && (
        <p className="stitek mt-2 !text-[#8ff0c0]">doručeno {z.doruceno}× </p>
      )}
