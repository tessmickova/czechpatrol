    ...
    <div className="rounded-[18px] border border-linka2 bg-plocha p-3.5">
      ...
      {diskuzeBezi ? (
        <a
          ...
          className="mt-2.5 flex min-h-[44px] items-center gap-2.5 rounded-[14px] border border-akcent/50 bg-akcent/12 px-3 transition-colors hover:bg-akcent/20"
        >
        ...
        <p className="mt-2.5 rounded-[14px] border border-dashed border-linka px-3 py-2.5 text-[12.5px] leading-relaxed text-tlum2">
