...
export function BannerStari({ overeno }: { overeno: string | null }) {
  ...
  return (
    <div role="status" className="border-b border-[#e08a3c]/40 bg-[#e08a3c]/10">
      <div className="mx-auto flex max-w-[1200px] items-start gap-2.5 px-4 py-2.5 text-[14px] text-[#eaa96b] sm:px-6">
