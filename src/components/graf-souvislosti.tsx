      ...
      <div className="hidden overflow-x-auto sm:block">
        ...
        >
          {souvisejici.map((s, i) => {
            ...
            return (
              <path
                ...
                fill="none"
                stroke={s.potvrzena ? "var(--color-inkoust)" : "var(--color-tlum2)"}
                strokeWidth="1.6"
          ...
          <g>
            ...
            <text x={STRED_X + 14} y={stredY - 6} fontSize="11.5" fill="var(--color-tlum2)" letterSpacing="0.9">
              TATO UDÁLOST
            </text>
            <text x={STRED_X + 14} y={stredY + 13} fontSize="15" fill="var(--color-inkoust)" fontWeight="600">
          ...
          {souvisejici.map((s, i) => {
            ...
            return (
              <g key={s.incident.id}>
                ...
                <text x={CIL_X + 14} y={y + 21} fontSize="11.5" fill="var(--color-tlum2)" letterSpacing="0.9">
                  {s.potvrzena ? "POTVRZENÁ SOUVISLOST" : "VYŠETŘOVANÁ SOUVISLOST"}
                </text>
                <text x={CIL_X + 14} y={y + 40} fontSize="15" fill="var(--color-inkoust)" fontWeight="600">
