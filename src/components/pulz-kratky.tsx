...
export function PulzKratky({ pulz, ted }: { pulz: Pulz; ted: number }) {
  ...
  return (
    <span className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-tlum2" title={pulz.kdy ? `Poslední průchod sběru ${new Date(pulz.kdy).toLocaleString("cs-CZ")} · sběr každých 30 minut` : "Sběr každých 30 minut"}>
