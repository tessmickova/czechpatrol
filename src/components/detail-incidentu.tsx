  ...
  return (
    <article className="mx-auto max-w-[860px] px-4 py-8 sm:px-6 sm:py-10">
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <Link href="/udalosti/" className="inline-flex min-h-[36px] items-center gap-1 text-male font-semibold text-tlum hover:text-inkoust">← Události</Link>
  ...
  return (
    <div className="mx-auto max-w-[640px] px-5 py-20 text-center sm:px-8">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-2.5">
        ...
        <Link href="/" className="rounded-[18px] border border-linka bg-plocha px-3 py-2 text-male font-medium transition-colors hover:border-inkoust">Přehled</Link>
      </div>
    </div>
  );
}
